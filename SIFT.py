...
psd_img_1 = cv2.imread('images/13.jpg', cv2.IMREAD_GRAYSCALE)
psd_img_2 = cv2.imread('images/14.jpg', cv2.IMREAD_GRAYSCALE)
psd_img_1 = cv2.resize(psd_img_1 ,(1000,700))
psd_img_2 = cv2.resize(psd_img_2 ,(1000,700))
# 3) SIFT特征计算
